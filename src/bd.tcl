...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net inverter_0_interrupt [get_bd_pins inverter_0/interrupt] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins inverter_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs inverter_0/s_axi_AXI_CPU/Reg] -force
